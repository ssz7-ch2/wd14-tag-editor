...
import { openFolderAtom, saveTagsAtom, tagAllImagesAtom } from 'renderer/atoms/derivedWriteAtom';
import './Menu.css';
...
function Menu() {
  ...
  return (
    <div id="menu">
      <MenuIcon icon={faFolder} text="Open Folder" color="rgb(219, 190, 25)" onClick={openFolder} />
      <MenuIcon
        icon={faPlayCircle}
        text="Tag Images"
      ...
      />
      <MenuIcon icon={faCircleStop} text="Cancel" color="rgb(236, 95, 100)" onClick={cancel} />
      <MenuIcon icon={faSave} text="Save Tags" color="rgb(101, 178, 230)" onClick={saveTags} />
